...
EPICS_APP_ADL_DIR=${EPICS_APP}/18IDdApp/op/adl
...
export START_PUTRECORDER=${EPICS_APP}/start_putrecorder_18IDd
export MACROS_PY=${EPICS_APP_ADL_DIR}/../python/macros_18IDd.py
export EDITOR=nedit

cd ${EPICS_APP}/18IDdApp/op/adl
medm 18IDd.adl&
