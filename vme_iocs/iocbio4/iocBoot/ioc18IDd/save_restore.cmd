...
save_restoreSet_NFSHost("cryptkeeper", "164.54.204.59")
...
#set_savefile_path("/opt/epics/synApps_5_2/support/18IDd/iocBoot/iocvxWorks", "autosave")
...
# first argument should be located in cdCommands
...
set_requestfile_path(top, "18IDdApp/Db")
#set_requestfile_path(epics_base, "../k428App/Db")
#
