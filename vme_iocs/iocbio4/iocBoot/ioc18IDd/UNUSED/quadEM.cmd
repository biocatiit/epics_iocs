...
dbLoadRecords("$(QUADEM)/quadEMApp/Db/quadEM.db", "P=18IDd:, EM=EM1, PORT=quadEM1")
dbLoadRecords("$(QUADEM)/quadEMApp/Db/quadEM.db", "P=18IDd:, EM=EM2, PORT=quadEM2")
dbLoadRecords("$(QUADEM)/quadEMApp/Db/quadEM.db", "P=18IDd:, EM=EM3, PORT=quadEM3")
dbLoadRecords("$(QUADEM)/quadEMApp/Db/quadEM.db", "P=18IDd:, EM=EM4, PORT=quadEM4")

# Database for FastSweep (mca records), i.e. quadEM digital scope
dbLoadRecords("$(QUADEM)/quadEMApp/Db/quadEM_med.db", "P=18IDd:quadEM:,NCHAN=2048,PORT=quadEMSweep")
dbLoadRecords("$(QUADEM)/quadEMApp/Db/quadEM_med_FFT.db", "P=18IDd:quadEM_FFT:,NCHAN=1024")
