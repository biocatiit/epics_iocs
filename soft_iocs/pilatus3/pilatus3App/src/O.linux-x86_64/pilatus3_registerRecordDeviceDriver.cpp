...
/* Generated from ../O.Common/pilatus3.dbd */
...
/* pilatus3_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: pilatus3_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(pilatus3_registerRecordDeviceDriver(*iocshPpdbbase));
}
