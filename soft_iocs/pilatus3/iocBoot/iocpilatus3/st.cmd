#!../../bin/linux-x86_64/pilatus3
#------------------------------------------------------------------------------
# Define environment variables
< envPaths
errlogInit(20000)

dbLoadDatabase("../../dbd/pilatus3.dbd")
pilatus3_registerRecordDeviceDriver(pdbbase) 

# Prefix for all records
epicsEnvSet("PREFIX", "18IDpil1M:")
...
asynOctetSetInputEos("camserver", 0, "\x18") #Maybe need to change?
