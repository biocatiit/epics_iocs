...
epicsShareExtern reg_func pvar_func_ACSTech80Register,
    ...
    pvar_func_NDDxpRegister, pvar_func_NDFFTRegister,
    ...
    pvar_func_NDPvaRegister, pvar_func_NDROIRegister,
    ...
    pvar_func_NewFocusRegister, pvar_func_NewportRegister,
    pvar_func_OrielRegister, pvar_func_Oxford_CS800Registrar,
    ...
    pvar_func_pf4Registrar, pvar_func_portDriverRegister,
...
int iocxxxLinux_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/opt/epics/synApps_6_3/support/xxx-R6-3";
    ...
    runRegistrarOnce(pvar_func_NDDxpRegister);
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: iocxxxLinux_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(iocxxxLinux_registerRecordDeviceDriver(*iocshPpdbbase));
}
