...
# XMS160-S
XPSCreateAxis("XPS1",0,"XY.X",   "1000000")
# ILS50PP
...
#Loads PCO records
dbLoadRecords("$(MOTOR)/db/XPSPositionCompare.db", "P=18ID_Newport_TR:,R=m1,PORT=XPS1,ADDR=0,PREC=6")
dbLoadRecords("$(MOTOR)/db/XPSPositionCompare.db", "P=18ID_Newport_TR:,R=m2,PORT=XPS1,ADDR=1,PREC=5")
