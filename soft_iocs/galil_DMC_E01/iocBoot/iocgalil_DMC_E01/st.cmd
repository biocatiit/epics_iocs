...
#dbLoadRecords("$(OPTICS)/opticsApp/Db/2slit_soft.vdb","P=18ID_DMC_E01:,SLIT=JJC_V:,mXp=1,mXn=2")
#dbLoadRecords("$(OPTICS)/opticsApp/Db/2slit_soft.vdb","P=18ID_DMC_E01:,SLIT=JJC_H:,mXp=4,mXn=3")
