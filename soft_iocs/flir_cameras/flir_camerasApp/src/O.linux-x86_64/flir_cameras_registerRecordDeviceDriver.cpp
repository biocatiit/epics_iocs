...
/* Generated from ../O.Common/flir_cameras.dbd */
...
static const char * const recordTypeNames[] = {
    ...
    "state", "stringin", "stringout", "sub", "subArray", "swait", "table",
...
epicsShareExtern reg_func pvar_func_ACSTech80Register,
    pvar_func_ADSpinnakerRegister, pvar_func_AG_CONEXRegister,
    pvar_func_AG_UCRegister, pvar_func_ANC150Register,
    pvar_func_AcsRegister, pvar_func_AerotechRegister,
    pvar_func_AsynDriverInterfaceRegistrar,
    pvar_func_EnsembleTrajectoryScanRegistrar,
    pvar_func_GalilSupportRegister, pvar_func_HXPRegister,
    ...
    pvar_func_Keithley65xxEMRegistrar, pvar_func_LabJackRegister,
    pvar_func_MCB4BRegister, pvar_func_MCDC2805Register,
    pvar_func_MM4005_trajectoryScanRegistrar, pvar_func_MVP2001Register,
    pvar_func_MclennanRegister, pvar_func_MicosmotorRegister,
    pvar_func_NDAttrPlotRegister, pvar_func_NDAttrRegister,
    pvar_func_NDBadPixelRegister, pvar_func_NDCircularBuffRegister,
    ...
    pvar_func_ParkerRegister, pvar_func_QSRVRegistrar,
    ...
    pvar_func_URLDriverRegister, pvar_func_USBCTR_SNLRegistrar,
    ...
    pvar_func_drvModbusAsynRegister, pvar_func_drvMultiFunctionRegister,
    pvar_func_drvScalerSoftRegister, pvar_func_drvUSBCTRRegister,
    pvar_func_drvXPSAsynAuxRegister, pvar_func_editSseqRegistrar,
    pvar_func_fastSweepRegister, pvar_func_femtoRegistrar,
    pvar_func_ffmpegFileRegister, pvar_func_ffmpegServerRegister,
    pvar_func_filterDriveRegistrar, pvar_func_flexCombinedMotionRegistrar,
    pvar_func_hrCtlRegistrar, pvar_func_installPVAAddLinkHook,
...
int flir_cameras_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/opt/epics/epics_iocs/soft_iocs/flir_cameras";
    ...
    runRegistrarOnce(pvar_func_LabJackRegister);
    ...
    runRegistrarOnce(pvar_func_NDPvaRegister);
    ...
    runRegistrarOnce(pvar_func_pilatusDetectorRegister);
...
/* flir_cameras_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: flir_cameras_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(flir_cameras_registerRecordDeviceDriver(*iocshPpdbbase));
}
