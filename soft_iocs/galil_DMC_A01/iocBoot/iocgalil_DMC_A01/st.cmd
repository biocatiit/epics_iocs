#!../../bin/linux-x86_64/galil_DMC_A01
...
dbLoadDatabase("dbd/galil_DMC_A01.dbd",0,0)
galil_DMC_A01_registerRecordDeviceDriver(pdbbase)
...
#dbLoadRecords("$(OPTICS)/opticsApp/Db/2slit_soft.vdb","P=18ID_DMC_A01:,SLIT=JJC_V:,mXp=1,mXn=2")
#dbLoadRecords("$(OPTICS)/opticsApp/Db/2slit_soft.vdb","P=18ID_DMC_A01:,SLIT=JJC_H:,mXp=4,mXn=3")
