...
/* Generated from ../O.Common/ioc18idLinux.dbd */
...
epicsShareExtern typed_rset *pvar_rset_aSubRSET, *pvar_rset_aaiRSET,
    ...
    *pvar_rset_swaitRSET, *pvar_rset_tableRSET, *pvar_rset_throttleRSET,
    *pvar_rset_timestampRSET, *pvar_rset_transformRSET, *pvar_rset_vsRSET,
...
static const char * const recordTypeNames[] = {
    ...
    "epid", "event", "fanout", "histogram", "int64in", "int64out",
    "longin", "longout", "lsi", "lso", "luascript", "mbbi", "mbbiDirect",
    "mbbo", "mbboDirect", "mca", "motor", "permissive", "printf",
    "scalcout", "scanparm", "sel", "seq", "sscan", "sseq", "state",
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_asynInt8ArrayAai,
    ...
    *pvar_dset_asynAiInt64, *pvar_dset_devGpib,
    ...
    *pvar_dset_devAiEtherIP, *pvar_dset_devAidg535,
    ...
    *pvar_dset_devLuaAo, *pvar_dset_devaoStream, *pvar_dset_devAoStats,
    *pvar_dset_devAoEtherIP, *pvar_dset_devAodg535,
    ...
    *pvar_dset_devBiEtherIP, *pvar_dset_devBidg535,
    ...
    *pvar_dset_devBoEtherIP, *pvar_dset_devBodg535,
    ...
    *pvar_dset_devMbbiEtherIP, *pvar_dset_devMbbidg535,
    ...
    *pvar_dset_devmbboStream, *pvar_dset_devMbboEtherIP,
    *pvar_dset_devMbbodg535, *pvar_dset_devMW100_mbbo,
    ...
    *pvar_dset_devSiEtherIP, *pvar_dset_devSidg535,
    ...
    *pvar_dset_devSoEtherIP, *pvar_dset_devSodg535,
    *pvar_dset_asynSoftGlue, *pvar_dset_devSASoft,
    ...
    *pvar_dset_devWaveformStats, *pvar_dset_devWfEtherIP;
...
static const char * const deviceSupportNames[] = {
    ...
    "asynAiInt64", "devGpib", "devAiTodSeconds", "devAiStrParm",
    "devAiHeidND261", "devAiMKS", "devAiMPC", "devAiGP307Gpib",
    "devAiAX301", "devAiTelevac", "devAiTPG261", "devLuaAi",
    "devaiStream", "devAiStats", "devAiClusts", "devAiEtherIP",
    "devAidg535", "devMW100_ai", "devAoSoft", "devAoSoftRaw",
    "devAoSoftCallback", "asynAoInt32", "asynAoFloat64", "asynAoInt64",
    "devAoStrParm", "devAoEurotherm", "devAoMPC", "devAoAX301",
    "devAoTPG261", "devLuaAo", "devaoStream", "devAoStats",
    "devAoEtherIP", "devAodg535", "devMW100_ao", "asynRecordDevice",
    ...
    "devbiStream", "devBiEtherIP", "devBidg535", "devMW100_bi",
    ...
    "devboStream", "devBoEtherIP", "devBodg535", "softGlueShow",
    ...
    "devmbbiStream", "devMbbiEtherIP", "devMbbidg535", "devMW100_mbbi",
    ...
    "devmbboStream", "devMbboEtherIP", "devMbbodg535", "devMW100_mbbo",
    ...
    "devSiTPG261", "devLuaStringin", "devstringinStream",
    "devStringinStats", "devStringinEnvVar", "devStringinEpics",
    "devSiEtherIP", "devSidg535", "devMW100_stringin", "devSoSoft",
    "devSoSoftCallback", "devSoStdio", "asynSoOctetWrite", "devSoStrParm",
    "devSoEurotherm", "devSoMPC", "devLuaStringout", "devstringoutStream",
    "devSoEtherIP", "devSodg535", "asynSoftGlue", "devSASoft",
    "devSWaitIoEvent", "devVacSen", "devWfSoft", "asynWfOctetCmdResponse",
    ...
    "asynInt32ArrayWfOut", "asynFloat32ArrayWfIn",
    ...
    "asynInt64TimeSeries", "devwaveformStream", "devWaveformStats",
    "devWfEtherIP"
};
...
static const dset * const devsl[] = {
    ...
    pvar_dset_asynAiInt32, pvar_dset_asynAiInt32Average,
    pvar_dset_asynAiFloat64, pvar_dset_asynAiFloat64Average,
    pvar_dset_asynAiInt64, pvar_dset_devGpib, pvar_dset_devAiTodSeconds,
    ...
    pvar_dset_devAiTelevac, pvar_dset_devAiTPG261, pvar_dset_devLuaAi,
    pvar_dset_devaiStream, pvar_dset_devAiStats, pvar_dset_devAiClusts,
    pvar_dset_devAiEtherIP, pvar_dset_devAidg535, pvar_dset_devMW100_ai,
    ...
    pvar_dset_devaoStream, pvar_dset_devAoStats, pvar_dset_devAoEtherIP,
    pvar_dset_devAodg535, pvar_dset_devMW100_ao,
    ...
    pvar_dset_devBiTPG261, pvar_dset_devLuaBi, pvar_dset_devbiStream,
    pvar_dset_devBiEtherIP, pvar_dset_devBidg535, pvar_dset_devMW100_bi,
    ...
    pvar_dset_devBoMPC, pvar_dset_devBoGP307Gpib, pvar_dset_devBoAX301,
    pvar_dset_devBoTPG261, pvar_dset_devLuaBo, pvar_dset_devboStream,
    pvar_dset_devBoEtherIP, pvar_dset_devBodg535, pvar_dset_softGlueShow,
    ...
    pvar_dset_devmbbiStream, pvar_dset_devMbbiEtherIP,
    pvar_dset_devMbbidg535, pvar_dset_devMW100_mbbi,
    ...
    pvar_dset_devStringinEpics, pvar_dset_devSiEtherIP,
    ...
    pvar_dset_devLuaStringout, pvar_dset_devstringoutStream,
    pvar_dset_devSoEtherIP, pvar_dset_devSodg535, pvar_dset_asynSoftGlue,
...
epicsShareExtern reg_func pvar_func_ACSTech80Register,
    ...
    pvar_func_MicosmotorRegister, pvar_func_NewFocusRegister,
    ...
    pvar_func_drvAsynCoherentSDGRegister, pvar_func_drvAsynColbyRegister,
    ...
    pvar_func_drvModbusAsynRegister, pvar_func_drvXPSAsynAuxRegister,
    pvar_func_editSseqRegistrar, pvar_func_fastSweepRegister,
    ...
    pvar_func_orientRegistrar, pvar_func_pf4Registrar,
...
int ioc18idLinux_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/opt/epics/iocs/epics_iocs/soft_iocs/BLEEPS";
...
/* ioc18idLinux_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: ioc18idLinux_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(ioc18idLinux_registerRecordDeviceDriver(*iocshPpdbbase));
}
