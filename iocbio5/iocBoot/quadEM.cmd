...
dbLoadRecords("$(QUADEM)/quadEMApp/Db/quadEM.db", "P=18ID:e:, EM=EM1, PORT=quadEM1")
dbLoadRecords("$(QUADEM)/quadEMApp/Db/quadEM.db", "P=18ID:e:, EM=EM2, PORT=quadEM2")
dbLoadRecords("$(QUADEM)/quadEMApp/Db/quadEM.db", "P=18ID:e:, EM=EM3, PORT=quadEM3")
dbLoadRecords("$(QUADEM)/quadEMApp/Db/quadEM.db", "P=18ID:e:, EM=EM4, PORT=quadEM4")

# Database for FastSweep (mca records), i.e. quadEM digital scope
dbLoadRecords("$(QUADEM)/quadEMApp/Db/quadEM_med.db", "P=18ID:e:quadEM:,NCHAN=2048,PORT=quadEMSweep")
dbLoadRecords("$(QUADEM)/quadEMApp/Db/quadEM_med_FFT.db", "P=18ID:e:quadEM_FFT:,NCHAN=1024")
